import {pulsarCelda, entrarRatonEnCelda, salirRatonDeCelda,
    soltarCelda, palabras
} from "./controlJuego.js";
import {crearTabla} from "./puntuaciones.js";

import {inicio} from "./inicio.js";


var TAM_PALABRA_MAYOR = palabramasLarga(palabras);
var TOTAL_LETRAS_PALABARAS = cantidadLetras(palabras);
...
export const caja = document.createElement("div");
...
export var tablero = crearTablero(tamTab);
...
export function recorrerPalabras() {
...
export function posicionarPalabra(palabra) {
...
export function posicionAleatoria(tamTablero){

    return parseInt(Math.random()*tamTablero);
}
export function rellenarTablero() {
